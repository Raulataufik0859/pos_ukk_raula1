    ...
    <div class="p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Perbarui data akun pengguna</p>
            </div>
        ...
        <form action="{{ url('/admin/users/update/' . $user->id) }}" method="POST">
            @csrf
            {{-- Route kamu POST, jangan pakai @method('PUT') --}}
                ...
                <div class="p-6 md:p-8 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" placeholder="Kosongkan jika tidak ingin diubah"
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 transition">
                        <p class="text-xs text-gray-400 mt-1">Kosongkan jika tidak ingin ganti password</p>
                    </div>
