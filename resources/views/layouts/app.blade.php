...
<head>
    ...
    <title>@yield('title', 'Puma Speedcat') - Sistem Kasir</title>
        ...
        <div id="main-content" class="flex-1 flex flex-col min-w-0 overflow-hidden transition-all duration-300">
            ...
            <header
                ...
                <div class="flex items-center gap-3">
                    ...
                    {{-- Logo + Brand (klik untuk lihat info perusahaan) --}}
                    <a href="{{ route('tentang') }}" class="flex items-center gap-2.5 group" title="Tentang Puma Speedcat">
