...
<aside id="sidebar"
    ...
    {{-- User Info (klik → profil seperti WhatsApp) --}}
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('jenis.index') }}"
            class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition
            {{ request()->is('jenis*') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800' }}">
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
