    ...
    <div class="p-6">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e(!empty($isKasir) ? 'Ringkasan transaksi Anda hari ini' : 'Ringkasan performa toko hari ini'); ?></p>
            </div>
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-2">
                                Rp <?php echo e(number_format($totalPenjualanHariIni ?? 0, 0, ',', '.')); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-0.5">Hari ini</p>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-2">
                                <?php echo e($jumlahTransaksiHariIni ?? 0); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-0.5">Hari ini</p>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-2">
                                Rp <?php echo e(number_format($totalTunaiHariIni ?? 0, 0, ',', '.')); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-2">
                                Rp <?php echo e(number_format($totalNonTunaiHariIni ?? 0, 0, ',', '.')); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $produkStokRendah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                                    <td class="px-5 py-3 text-gray-500">
                                        <?php echo e(method_exists($produkStokRendah, 'firstItem') ? $produkStokRendah->firstItem() + $index : $index + 1); ?>

                                    </td>
                                    <td class="px-5 py-3 font-medium text-gray-900 dark:text-white"><?php echo e($produk->nama); ?></td>
                ...
                <?php if(method_exists($produkStokRendah, 'hasPages') && $produkStokRendah->hasPages()): ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            <?php $__empty_1 = true; $__currentLoopData = $produkStokHabis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                                    <td class="px-5 py-3 text-gray-500">
                                        <?php echo e(method_exists($produkStokHabis, 'firstItem') ? $produkStokHabis->firstItem() + $index : $index + 1); ?>

                                    </td>
                                    <td class="px-5 py-3 font-medium text-gray-900 dark:text-white"><?php echo e($produk->nama); ?>
                ...
                <?php if(method_exists($produkStokHabis, 'hasPages') && $produkStokHabis->hasPages()): ?>
                    <div class="px-5 py-3 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $produkTerlaris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                                <td class="px-5 py-3">
                                    ...
                                    <?php else: ?>
                                        <span class="text-gray-500 pl-2"><?php echo e($index + 1); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-5 py-3 font-medium text-gray-900 dark:text-white"><?php echo e($produk->nama); ?></td>
                                <td class="px-5 py-3 text-center text-gray-600 dark:text-gray-300"><?php echo e($produk->stok); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hype AMD\Downloads\pos_ukk_raula1\resources\views/dashboard.blade.php ENDPATH**/ ?>